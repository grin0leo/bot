...
async def handle_message(update: Update, context: CallbackContext) -> None:
    ...
    # обработка ввода вне активной стадии выбор вариантов
        ...
        await update.message.reply_text('Пожалуйста, выберите опцию, команду /start или отправьте запрос, например: "Изменить тариф", "Заключить договор" или "Подключить услуги".')
